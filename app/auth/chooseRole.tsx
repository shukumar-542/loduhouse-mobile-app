    ...
    <View className="flex-1 bg-black px-6 py-8">
      ...
      <View className="space-y-10">
        ...
        <TouchableOpacity
          ...
          className={`relative p-6 rounded-[32px] border-2 items-center justify-center ${
            selectedRole === 'artist' 
        ...
        <TouchableOpacity
          ...
          className={`relative p-6 rounded-[32px] mt-12 border-2 items-center justify-center ${
