    ...
    return (
        <View className="bg-[#111111] p-5 rounded-[32px] border border-[#262626] w-full max-w-[380px] self-center mt-8">
            ...
            <View className="flex-row justify-between items-center mb-5">
                ...
                <View className="bg-[#F0B10033] px-3 py-1.5 rounded-full">
                    <Text className="text-[#FDC700] text-sm font-semibold">
                        Pending
                    </Text>
                </View>
            </View>
            ...
            <View className="flex-row items-center gap-x-2">
                <Hourglass size={18} color="#FDC700" />
                <Text className="text-[#FDC700] text-base font-medium">
                    Waiting for studio owner approval
                </Text>
            </View>
